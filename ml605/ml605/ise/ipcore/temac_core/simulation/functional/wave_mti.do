...
add wave -noupdate -format Logic /testbench/dut/temac_core_locallink_inst/tx_enable_i
add wave -noupdate -format Literal -hex /testbench/dut/temac_core_locallink_inst/tx_data_i
add wave -noupdate -format Logic /testbench/dut/temac_core_locallink_inst/tx_data_valid_i
add wave -noupdate -format Logic /testbench/dut/temac_core_locallink_inst/tx_ack_i
...
add wave -noupdate -format Logic /testbench/dut/temac_core_locallink_inst/rx_enable_i
add wave -noupdate -format Literal -hex /testbench/dut/temac_core_locallink_inst/rx_data_i
add wave -noupdate -format Logic /testbench/dut/temac_core_locallink_inst/rx_data_valid_i
add wave -noupdate -format Logic /testbench/dut/temac_core_locallink_inst/rx_good_frame_i
add wave -noupdate -format Logic /testbench/dut/temac_core_locallink_inst/rx_bad_frame_i
...
add wave -noupdate -format Logic /testbench/gmii_col
add wave -noupdate -format Logic /testbench/gmii_crs
