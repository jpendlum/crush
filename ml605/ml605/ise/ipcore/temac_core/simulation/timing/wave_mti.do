...
add wave -noupdate -label dut/tx_enable_i -format Logic -hex /testbench/dut/\\temac_core_locallink_inst/tx_enable_i\\
add wave -noupdate -label dut/tx_data_i -format Literal -hex /testbench/dut/\\temac_core_locallink_inst/tx_data_i\\
add wave -noupdate -label dut/tx_data_valid_i -format Logic /testbench/dut/\\temac_core_locallink_inst/tx_data_valid_i\\
...
add wave -noupdate -label dut/rx_data_i -format Literal -hex /testbench/dut/\\temac_core_locallink_inst/rx_data_i\\
add wave -noupdate -label dut/rx_data_valid_i -format Logic /testbench/dut/EMACCLIENTRXDVLD
add wave -noupdate -label dut/rx_good_frame_i -format Logic /testbench/dut/\\temac_core_locallink_inst/rx_good_frame_i\\
add wave -noupdate -label dut/rx_bad_frame_i -format Logic /testbench/dut/\\temac_core_locallink_inst/rx_bad_frame_i\\
